                        ...
                        <ol class="flex items-center space-x-4">
                            <li>
                                <div class="flex items-center">
                                    <inertia-link class="text-3xl font-extrabold text-gray-900"
                                        :href="route('events.index')">EVENEMENTS</inertia-link>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                                        aria-current="page">Créer un evenement</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <form @submit.prevent="submit">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <!-- <div class="col-span-12 sm:col-span-6">
                                    <label class="block text-sm font-medium text-gray-700" for="import_fichier">Importer un fichier:</label>
                                    <input v-model="form.import_fichier" name="import_fichier" id="import_fichier"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                        type="number" />
                                    <div v-if="errors.import_fichier" class="text-red-700 mt-2 text-sm">{{
                                    errors.import_fichier }}</div>
                                </div> -->
                                <!-- 
                        <div class="col-span-12 sm:col-span-6">
                        ...
                        <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex justify-end items-center">
                            <loading-button :loading="sending"
                                ...
                                type="submit">Enregistrer</loading-button>
                        </div>
                    </form>
                </div>
