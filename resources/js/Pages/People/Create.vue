                            ...
                            <li>
                                <div class="flex items-center">
                                    <inertia-link class="text-3xl font-extrabold text-gray-900"
                                        :href="route('people.index')">UTILISATEURS</inertia-link>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                                        aria-current="page">Créer un utilisateur</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-8 sm:col-span-4">
                                    ...
                                    <input v-model="form.time_event" name="time_event" id="time_event"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" type="time" />
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input v-model="form.nbr_personnes" name="nbr_personnes" id="nbr_personnes"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                        type="number" />
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.$inertia.post(this.route('people.store'), this.form, {
        ...
        onInput(phone, phoneObject, input) {
            if (phoneObject?.formatted) {
                ...
                this.form.phone_number = phoneObject.number
            }
        },
